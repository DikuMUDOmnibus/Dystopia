...
int bprintf(BUFFER *buffer, char *fmt, ...)
{
  ...
  {
    buf[0] = '\0';
    bug("Overflow when printing string.", 0);
  }
  else
...
{
    send_to_char( "#y-========- #9Entering EDIT Mode#y -=========-\n\r", ch );
    send_to_char( "#9    Type /h on a new line for help\n\r", ch );
    send_to_char( "#9 Terminate with a ~ or @ on a blank line.\n\r", ch );
    send_to_char( "#y-=======================================-\n\r", ch );
...
{
    send_to_char( "#y-=======- #9Entering APPEND Mode #y-========-\n\r", ch );
    send_to_char( "#9    Type /h on a new line for help\n\r", ch );
    send_to_char( "#9 Terminate with a ~ or @ on a blank line.\n\r", ch );
    send_to_char( "#y-=======================================-\n\r", ch );
