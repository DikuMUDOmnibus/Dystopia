...
const struct flag_type area_bits[] =
{
  ...
  { "olc",                AREA_BIT_OLC,          TRUE },
  { "nopenta",            AREA_BIT_NOPENTA,      TRUE },
  { "",                   0,                     0    }
};
...
const struct flag_type exit_flags[] =
{
    ...
    { 	"shadow_wall",		EX_SHADOW_WALL,		TRUE	},
...
const struct flag_type room_flags[] =
{
    ...
    {   "dispel_magic",         ROOM_DISPEL_MAGIC,      FALSE   },
    { 	"flaming",		ROOM_FLAMING,		TRUE	},
    {   "silence",		ROOM_SILENCE,		TRUE	},
    {   "astral",		ROOM_ASTRAL,		TRUE	},
    {   "kingdom",              ROOM_KINGDOM,           TRUE    },
    {   "always_light",         ROOM_LIGHT,             TRUE    },
    {   "no_home",              ROOM_NO_HOME,           TRUE    },
    {   "no_random",            ROOM_NO_RANDOM,         TRUE    },
    {	"",			0,			0	}
};
...
const struct flag_type type_flags[] =
{
    ...
    {	"wall",			ITEM_WALL,		TRUE	},
    {   "quest-clue",           ITEM_QUESTCLUE,         FALSE   },
    {   "homing-device",        ITEM_HOMING,            FALSE   },
    {   "faetoken",             ITEM_FAETOKEN,          FALSE   },
    {	"",			0,			0	}
};
...
const struct flag_type extra_flags[] =
{
    ...
    {   "rare",                 ITEM_RARE,              FALSE   },
    {   "sentient",             ITEM_SENTIENT,          FALSE   },
    {   "gemmed",               ITEM_GEMMED,            TRUE    },
    {   "fae-blasted",          ITEM_FAE_BLAST,         TRUE    },
    {   "mastery",              ITEM_MASTERY,           TRUE    },
    {   "unbreakable",          ITEM_UNBREAKABLE,       FALSE   },
    {   "norepair",             ITEM_NOREPAIR,          FALSE   },
    {	"",			0,			0	}
};
...
const struct flag_type act_flags[] =
{
    ...
    {   "semiaggressive",       ACT_SEMIAGGRESSIVE,     FALSE   },
    ...
    {   "banding",              ACT_BANDING,            TRUE    },
    {   "nostance",             ACT_NOSTANCE,           TRUE    },
    {	"",			0,			0	}
};
...
const struct flag_type affect_flags[] =
{
    ...
    {	"fire-shield",		AFF_FIRESHIELD,   	TRUE	},
    ...
    {	"mindboost",		AFF_MINDBOOST,		TRUE	},
    {   "web",                  AFF_WEBBED,             TRUE    },
    {   "mindblank",            AFF_MINDBLANK,          TRUE    },
    {	"",			0,			0	}
};
